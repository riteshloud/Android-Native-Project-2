...
public class ResideMenu extends FrameLayout {
    ...
    public RelativeLayout menuHolder;
    /**
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        if (customLeftMenuId >= 0) {
            ...
            ivClose = (ImageView) scrollViewLeftMenu.findViewById(R.id.iv_close);
    ...
    /**
     * The visibility of the shadoww under the activity;
     *
     * @param isVisible
     */
    ...
    public void enableDirection(int direction) {
        for (int i = 0; i < disabledSwipeDirection.size(); i++) {
